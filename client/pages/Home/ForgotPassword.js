                ...
                <div className="bg-white rounded md:rounded-lg shadow md:shadow-md px-2 py-4 md:p-8 text-base md:text-lg leading-normal">
                    <form>
                        <div className="text-center">
                            ...
                            <input
                                className="bg-gray-200 w-4/5 ml-2 sm:ml-3 p-2 rounded-lg inline"
                                name="email"
                                type="email"
                        ...
                        <input
                            className="block text-white border border-blue-500 bg-blue-500 rounded-full shadow mx-auto px-5 py-2 md:px-6 rounded mt-4"
                            type="submit"
                            value="Reset"
                        />
                    </form>
